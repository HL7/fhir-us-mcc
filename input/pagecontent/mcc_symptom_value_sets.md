This table holds the value sets that may be used with the [MCC Symptom Observation Profile](http://hl7.org/fhir/us/mcc/StructureDefinition/MCCSymptomObservation). 
**Table Key**
...
<table border="1" cellspacing="0" style="width:100.0%">
	<tbody>
		...
		<tr>
			...
			<td style="height:12.75pt; vertical-align:top; width:32%">
			<p>This set of values reflect patients with an extreme tiredness or feeling &lsquo;wiped out&rsquo; that persists despite resting or getting a good night&#39;s sleep. This includes physical fatigue such as post-exertional malaise and mental fatigue.</p>
			</td>
			<td style="height:12.75pt; vertical-align:top; width:20%">
		...
		<tr>
			...
			<td style="height:12.75pt; vertical-align:top; width:32%">
			<p>This set of values reflect patients experiencing sore throat pain.</p>
			</td>
			<td style="height:12.75pt; vertical-align:top; width:20%">
